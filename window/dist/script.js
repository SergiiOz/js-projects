...
var forms = function forms() {
  ...
  var allInputs = document.querySelectorAll('input'); //create object with text message
  ...
  allForms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); //create 'div' for message

      var statusMessage = document.createElement('div'); //add class to div

      statusMessage.classList.add('status');
      item.appendChild(statusMessage); //if we pass the form to constructor, object automatic will read all field from form
...
var modals = function modals() {
  ...
  var bindModal = function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var close = document.querySelector(closeSelector); //pseudo array selectors
    ...
    trigger.forEach(function (item) {
      ...
      item.addEventListener('click', function (e) {
        ...
        modal.style.display = 'block'; // //when open modal - scroll from right side - hide

        document.body.style.overflow = 'hidden'; // //open modal window - with add bootstrap class
    ...
    close.addEventListener('click', function () {
      ...
      document.body.style.overflow = ''; //close modal window - with remove bootstrap class
  ...
  var showModalByTime = function showModalByTime(targetSelector, time) {
    setTimeout(function () {
  ...
  bindModal('.popup_engineer_btn', '.popup_engineer', '.popup_engineer .popup_close'); //run by link

  bindModal('.phone_link', '.popup', '.popup .popup_close'); //run by time
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var header = document.querySelector(headerSelector); //pseudo array selectors
  ...
  hideTabContent();
  showTabContent(); //hang eventListener 'click' to parent element, who contain all tabs
    ...
    if (target && (target.classList.contains(tabSelector.replace(/\./, '')) || target.parentNode.classList.contains(tabSelector.replace(/\./, '')))) {
      tabs.forEach(function (item, index) {
        if (target == item || target.parentNode == item) {
          ...
          hideTabContent(); // show content === index
